" Base 16 Gruvbox dark, hard scheme by Dawid Kurek (dawikur@gmail.com), morhetz (https://github.com/morhetz/gruvbox)
...
let g:airline#themes#base16_gruvbox_dark_hard#palette.normal_modified = { 'airline_c': [ s:gui0A, '', s:cterm0A, '' ] }
...
let g:airline#themes#base16_gruvbox_dark_hard#palette.insert_modified = g:airline#themes#base16_gruvbox_dark_hard#palette.normal_modified
let g:airline#themes#base16_gruvbox_dark_hard#palette.insert_paste = { 'airline_a': s:I3 }
...
let g:airline#themes#base16_gruvbox_dark_hard#palette.replace_modified = g:airline#themes#base16_gruvbox_dark_hard#palette.normal_modified
...
let g:airline#themes#base16_gruvbox_dark_hard#palette.visual_modified = g:airline#themes#base16_gruvbox_dark_hard#palette.normal_modified
...
let g:airline#themes#base16_gruvbox_dark_hard#palette.inactive_modified = g:airline#themes#base16_gruvbox_dark_hard#palette.normal_modified


let g:airline#themes#base16_gruvbox_dark_hard#palette.accents = { 'red': [ s:gui08, '', s:cterm08, '' ] }
